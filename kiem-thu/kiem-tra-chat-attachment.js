/** Release-bounded attachment proof: provider transport, canonical self share.file,
 * no fabricated media metadata, and realtime file/image rendering. */
...
const source = (file) => fs.readFileSync(path.join(REPO, file), "utf8").replace(/\r\n/g, "\n");
const ketQua = [];
...
await bai("C07", "realtime image giữ aspect ratio và chặn overflow", () => {
