...
export async function themLichHen({ dichId, dichTen, loai, noiDung, lucGui, lapLai, cauLenh, khan }) {
  const result = await run(
    `INSERT INTO lich_hen (dich_id, dich_ten, loai, noi_dung, luc_gui, lap_lai, trang_thai, cau_lenh, tao_luc, khan)
     VALUES (?, ?, ?, ?, ?, ?, 'cho', ?, ?, ?)`,
    [
      String(dichId),
